...
" Both vim and nvim {{{2
  ...
  set cursorline
  set updatetime=300  " After 300ms nothing is typed, .swp is written and gitgutter is updated.
...
" For vim only {{{2
"if !has('nvim')
"" powerline (this has to be first, for other scripts depends on some variables) {{{3
...
" tablines {{{3
  "source ~/.vim/DQScripts/tablines.vim
...
" AutoPairs {{{3
  ...
  map <leader>pn <M-n>
  imap <C-b>ee <M-e>
  imap <C-b>e2 <M-e><M-e><C-o>ge<C-o>ge<M-e><M-e><C-o>h
  imap <C-b>e1 <M-e><C-o>ge<C-o>ge<M-e><M-e><C-o>h
  imap <C-b>b <M-b>
